    ...
    const testimonials = [
        {
            ...
            Des: t("testimonials.testimonial1.description"),
            ...
            <div className="col-lg-4">
                <div className="deals_winner_customers">
                    <h3 className="title_text">
                        <mark>1,900+</mark> {t('clients_won_deals')}
                    </h3>
                    <div className="row">
                        <div className="col-6">
                            <div className="review_short_info">
                                ...
                                <div className="review_counter">{t('over')} <b>200+</b> {t('reviews')}</div>
                            </div>
                        </div>
                        <div className="col-6">
                            <div className="review_short_info">
                                ...
                                <div className="review_counter">{t('over')} <b>300+</b> {t('reviews')}</div>
                            </div>
                        </div>
                    </div>
                </div>
