                        ...
                        <ul className="empowering_services unordered_list_block ps-lg-5">
                            <li>
                                <div className="iconbox_block layout_icon_left">
                                    ...
                                    <div className="iconbox_content">
                                        <h3 className="iconbox_title">{t('tailored_solutions_title')}</h3>
                                        <p className="mb-0">
                            ...
                            <li>
                                <div className="iconbox_block layout_icon_left">
                                    ...
                                    <div className="iconbox_content">
                                        <h3 className="iconbox_title">{t('collaborative_title')}</h3>
                                        <p className="mb-0">
                            ...
                            <li>
                                <div className="iconbox_block layout_icon_left">
                                    ...
                                    <div className="iconbox_content">
                                        <h3 className="iconbox_title">{t('expert_team_title')}</h3>
                                        <p className="mb-0">
                                            {t('expert_team_desc')}
                                        </p>
                                    </div>
